...
void TexHandler::deleteTexture(int index) {
	...
	textures[index].channels = NULL;
	textures[index].width = NULL;
	textures[index].height = NULL;
	textures[index].diffID = NULL;
	textures[index].specID = NULL;
	textures[index].normID = NULL;
	textures[index].path = "";
}
